...
export default function Sidebar() {
  return (
    <>
      {/* --- DESKTOP SIDEBAR --- */}
      <nav className="fixed top-0 left-0 h-screen w-30 bg-white dark:bg-[#111] border-r border-zinc-200 dark:border-zinc-900 hidden md:flex flex-col items-center text-xs text-center z-50 transition-colors duration-300">
        <div className="w-full relative h-30 mb-4">
          <Image 
      ...
      <div className="md:hidden fixed bottom-0 left-0 w-full z-50 bg-white/80 dark:bg-black/80 backdrop-blur-xl border-t border-zinc-200 dark:border-zinc-800 text-[10px] flex justify-around items-center pb-6 pt-2 px-2 transition-colors duration-300">
